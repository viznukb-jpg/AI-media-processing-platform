...
export const s3BucketName = process.env.AWS_S3_BUCKET_NAME || "ai-media-platform-dev";
...
export const s3Client = new S3Client({
  ...
  forcePathStyle: !!process.env.AWS_S3_ENDPOINT, // for MinIO compatibility if needed
});
