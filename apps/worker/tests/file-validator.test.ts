...
describe('file-validator', () => {
  ...
  it('should throw for unknown types', async () => {
    ...
    await expect(validateFileType('dummy.txt')).rejects.toThrow('Unsupported or unrecognized file type: unknown');
  });
  ...
  it('should throw for unsupported mime types', async () => {
    ...
    await expect(validateFileType('dummy.pdf')).rejects.toThrow('Unsupported file type: application/pdf');
  });
});
